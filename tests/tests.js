(function() {
  ...
  var myApp = require('../app/prototype.js');
...
var oneToTwenty = myApp.Array.toTwenty();
var twoToForty = myApp.Array.toForty();
var tenToOneThousand = myApp.Array.toOneThousand();*/
